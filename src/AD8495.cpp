...
AD8495::AD8495(uint8_t analogPin, uint16_t adcMaxValue, float adcRefV, float ampRefV)
{
...
void AD8495::readADC(uint16_t numSamples)
{
    uint32_t adcValue = 0;
    for (uint16_t i = 0; i < numSamples; i++) adcValue += analogRead(_analogPin);
    adcValue /= numSamples;
